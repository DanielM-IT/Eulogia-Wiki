...
| **Crucible** | A qualifying primary bolt ignites the target for 3 / 4 / 5 seconds. | III | Ghast, Dragonfire Arrows |
...
| **Recoil** | Pushes the shooter backward with 0.30 / 0.45 / 0.60 force once per discharge. | III | — |
