...
**7 enchantments are compatible with Shears.**

Every enchantment on this page can be applied to **Shears** equipment, so the compatibility column is intentionally omitted.
