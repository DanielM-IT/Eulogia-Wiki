...
|---|---|:---:|---|---|
| **Adrenaline** | Crossing below 25% ordinary health from combat damage grants 30% movement speed for seven seconds. | I | <span title="Leggings">👖</span> | — |
| **Aspect of the Enderman** | Increases block-interaction reach by 1 / 2 / 3 blocks while preserving line of sight and protection checks. | III | <span title="Chestplate">🥋</span> <span title="Elytra">🪽</span> | — |
| **Berserker Plate** | Direct damage scales continuously with missing health up to 10% / 20% / 30%. | III | <span title="Chestplate">🥋</span> | — |
| **Block Breather** | Has a 25% / 50% / 75% chance to ignore a suffocation-damage event. | III | <span title="Helmet">🪖</span> | — |
| **Cognition** | Reduces the displayed vanilla anvil XP cost by 10% / 20% / 30%. | III | <span title="Helmet">🪖</span> | — |
| **Counterstrike** | Qualifying combat damage stores one direct-attack bonus of 10% / 15% / 20%. | III | <span title="Chestplate">🥋</span> | — |
| **Curse of Hunger** | Increases ordinary exhaustion accumulation by 50%. | I | <span title="Helmet">🪖</span> | — |
| **Darkness Cloak** | Eligible melee contact has a 5% / 7.5% / 10% chance to apply Darkness. | III | <span title="Chestplate">🥋</span> <span title="Elytra">🪽</span> | — |
| **Deflect** | Has a 3% / 5% / 7% chance to completely negate a qualifying original incoming attack. | III | <span title="Chestplate">🥋</span> | — |
| **Dragonhide** | Has a 10% / 15% / 20% chance to reduce a qualifying hit by 15% / 20% / 25%. | III | <span title="Chestplate">🥋</span> | — |
| **Elemental Protection** | Reduces qualifying magical and elemental damage by 10% / 15% / 20%. | III | <span title="Boots">🥾</span> | — |
| **Feather Step** | Prevents trampling farmland, turtle eggs and similar fragile blocks. | I | <span title="Boots">🥾</span> | — |
| **Fire Shield** | Eligible melee contact has a 5% / 7.5% / 10% chance to ignite the attacker for 2 / 3 / 4 seconds. | III | <span title="Chestplate">🥋</span> <span title="Elytra">🪽</span> | — |
| **Focal** | Deals 4% / 6% / 8% more direct damage when exactly one visible qualifying enemy is nearby and is the target. | III | <span title="Helmet">🪖</span> | — |
| **Fortitude** | Increases qualifying original direct-attack damage by 2% / 4% / 6%. | III | <span title="Leggings">👖</span> | — |
| **Frost Ward** | Eligible melee contact has a 5% / 7.5% / 10% chance to slow and freeze the attacker. | III | <span title="Chestplate">🥋</span> <span title="Elytra">🪽</span> | — |
| **Grounded Heal** | While sneaking outside combat, restores one health every 4 / 3 / 2 seconds. | III | <span title="Boots">🥾</span> | — |
| **Hard Worker** | Increases EcoJobs job XP by 5% / 10% / 15%. | III | <span title="Helmet">🪖</span> | — |
| **Hardened** | Qualifying combat damage has a 10% / 15% / 20% chance to grant Resistance I for 3 / 4 / 5 seconds. | III | <span title="Chestplate">🥋</span> <span title="Elytra">🪽</span> | — |
| **Insulate** | Reduces fire, burning and lava damage by 10% / 20% / 30%. | III | <span title="Chestplate">🥋</span> | — |
| **Iron Will** | Reduces eligible incoming damage by 10% / 15% / 20% while below 25% maximum health. | III | <span title="Leggings">👖</span> | — |
| **Lava Walker** | Temporarily converts eligible surface lava into magma in a 2 / 3 / 4 block radius. | III | <span title="Boots">🥾</span> | — |
| **Leaping** | Grants Jump Boost I, primarily allowing fences and similar 1.5-block obstacles to be cleared. | I | <span title="Boots">🥾</span> | — |
| **Leech** | Valid direct melee kills heal one health, with a one-second cooldown. | I | <span title="Leggings">👖</span> | — |
| **Mindforge** | Increases ordinary Minecraft XP by 5% / 10% / 15%. | III | <span title="Helmet">🪖</span> | — |
| **Mindshield** | Reduces Poison and Wither tick damage by 20% / 35% / 50%. | III | <span title="Helmet">🪖</span> | — |
| **Night Vision** | Grants Night Vision while the helmet is equipped. | I | <span title="Helmet">🪖</span> | — |
| **Nourishment** | Increases hunger and saturation restored by food by 10% / 20% / 30%. | III | <span title="Chestplate">🥋</span> | — |
| **Padded** | Reduces qualifying direct projectile damage by 10% / 15% / 20%. | III | <span title="Helmet">🪖</span> | — |
| **Regrowth** | Outside combat, restores one health every 6 / 4 / 3 seconds. | III | <span title="Chestplate">🥋</span> <span title="Elytra">🪽</span> | — |
| **Reinforced** | Adds one armour toughness while equipped in the correct slot. | I | <span title="Helmet">🪖</span> <span title="Chestplate">🥋</span> <span title="Leggings">👖</span> <span title="Boots">🥾</span> <span title="Elytra">🪽</span> | — |
| **Saturation** | Periodically restores hidden saturation while the wearer is already well fed. | I | <span title="Helmet">🪖</span> | — |
| **Stamina** | Reduces sprinting exhaustion by 10% / 20% / 30%. | III | <span title="Chestplate">🥋</span> | — |
| **Steadfast** | Reduces explosion damage by 10% / 20% / 30% and explosion knockback by 25% / 50% / 75%. | III | <span title="Chestplate">🥋</span> | — |
| **Steady** | Grants 5% / 10% / 15% ordinary knockback resistance. | III | <span title="Leggings">👖</span> | — |
| **Sustenance** | Outside combat, restores one visible hunger point every 30 seconds while walking. | I | <span title="Leggings">👖</span> | — |
| **Swiftness** | Increases movement speed by 5% / 10% / 15%. | III | <span title="Boots">🥾</span> | — |
| **Venom Plating** | Eligible melee contact has a 5% / 7.5% / 10% chance to apply Poison I for 3 / 4 / 5 seconds. | III | <span title="Chestplate">🥋</span> | — |
...
| **Silk Spawner** | Gives a 25% chance to recover a directly broken eligible spawner. | I | <span title="Pickaxe">⛏️</span> | Curse of Misfortune, Smelter |
| **Smelter** | Automatically smelts configured eligible drops without fuel or furnace XP. | I | <span title="Pickaxe">⛏️</span> | Silk Touch, Silk Chest, Silk Spawner |
| **Telekinesis** | Sends eligible block, crop and qualifying enemy drops to the player inventory. | I | <span title="Axe">🪓</span> <span title="Pickaxe">⛏️</span> <span title="Shovel">🪏</span> <span title="Hoe">🌾</span> | — |
...
| Name | Summary | Max Level | Compatible Items | Incompatible With |
|---|---|:---:|---|---|
| **Abyssal** | A sneak-armed throw teleports the player to a safe position beside the first impact. | I | <span title="Trident">🔱</span> | Riptide |
| **Contagion** | A thrown impact has a 5% / 10% chance to create a short Poison I cloud. | II | <span title="Trident">🔱</span> | Riptide, Venom |
| **Harpooning** | Adds 0.75 direct damage per level to qualifying melee, thrown and Riptide trident hits. | V | <span title="Trident">🔱</span> | — |
| **Infernus** | A directly struck entity is ignited for 3 / 4 / 5 seconds by a thrown trident. | III | <span title="Trident">🔱</span> | Riptide |
...
| Name | Summary | Max Level | Compatible Items | Incompatible With |
|---|---|:---:|---|---|
| **Coral Finder** | A completed item catch has a 5% / 10% / 15% chance to add one configured sea-loot item. | III | <span title="Fishing Rod">🎣</span> | — |
| **Curse of Drowned** | A completed item catch has a 5% chance to be replaced by one normal Drowned. | I | <span title="Fishing Rod">🎣</span> | — |
| **Double Catch** | A completed eligible item catch has a 10% / 15% / 20% chance to create an identical duplicate. | III | <span title="Fishing Rod">🎣</span> | — |
| **Mariner’s Wrath** | During genuine rain or thunder, reduces fishing wait time by 15% / 25% / 35%. | III | <span title="Fishing Rod">🎣</span> | — |
| **River Master** | Increases bobber launch velocity by 25% / 50% / 75%. | III | <span title="Fishing Rod">🎣</span> | — |
...
| Name | Summary | Max Level | Compatible Items | Incompatible With |
|---|---|:---:|---|---|
| **Blast Ward** | Reduces qualifying blocked explosion damage by 15% / 20% / 25%. | III | <span title="Shield">🛡️</span> | — |
| **Sentinel** | Adds 3 / 4 / 5 effective armour while stationary and actively blocking. | III | <span title="Shield">🛡️</span> | — |
...
| Name | Summary | Max Level | Compatible Items | Incompatible With |
|---|---|:---:|---|---|
| **Aero Shield** | Reduces qualifying incoming damage by 10% / 15% / 20% while genuinely gliding. | III | <span title="Elytra">🪽</span> | — |
| **Air Cushion** | Reduces qualifying landing damage after genuine elytra flight by 20% / 35% / 50%. | III | <span title="Elytra">🪽</span> | — |
